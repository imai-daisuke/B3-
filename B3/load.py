...
def road_builder(level,start_x,start_y,start_z,area_size_x,area_size_z):
    s_x=start_x
    s_z=start_z
    s_y=start_y
    ...
    for i in range(walking_space,areasize[0]-walking_space):
        for j in range(walking_space,areasize[1]-walking_space):
            road_area[j][i]=0
    road(level,s_x,s_y,s_z,areasize,road_area,walking_space)
#center_line=2,road=0,walk=1

def road(level,s_x,s_y,s_z,areasize,road_area,walking_space):
    n_direction=1# 0:road 1:other
    s_direction=0
    e_direction=0
    w_direction=0
